...
public class Relation {
    ...
    // getter and setter
    public int getNum_attribute() {
        return num_attributes;
    }

    public int getNum_tuple() {
        return num_tuples;
    }
    ...
    public Attribute getAttribute(String attr_name) {
        return attributes[getAttrIdx(attr_name)];
    }
    ...
    // this will only need to be call once for every Relation object, since the
    // attribute array is final array and won't be modified
